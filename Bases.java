...
abstract class BuyerBase<V> implements Runnable {
    ...
    public abstract void buy()
        throws InterruptedException; // Implements the buy (consume) method from shared queue
...
abstract class SellerBase<V> implements Runnable {
    ...
    public abstract void sell()
        throws InterruptedException; // Implements the sell (produce) method to shared queue
